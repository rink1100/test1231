<?php /*a:2:{s:80:"D:\phpstudy_pro\WWW\error\xdnyjqrsys.top\application\admin\view\index\index.html";i:1649234479;s:75:"D:\phpstudy_pro\WWW\error\xdnyjqrsys.top\application\admin\view\layout.html";i:1649390315;}*/ ?>
<!DOCTYPE html>
<html>
...
<body class="layui-layout-body layui-all layui-multi-module">
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
        	...
        	<div class="layui-header-content">
		        ...
		        <ul class="layui-nav layui-layout-right">
                    ...
                    <li class="layui-nav-item layui-hide-xs"><a href="javascript:;" data-check-screen="full"><i class="layui-icon layui-icon-screen-full" title="全屏"></i></a></li>
        ...
        <div class="layui-footer">
            ©  v<?php echo htmlentities(app('config')->get('version.yzncms_version')); ?>
        </div>
    </div>
